...
shuffle_index = np.random.permutation(60000)#返回一组随机的数据 shuffle 打乱60000中每行的值
...
for train_index, test_index in skfolds.split(X_train, y_train_5):
    ...
    X_train_folds = X_train[train_index]#对应的是训练集中训练的X
    y_train_folds = y_train_5[train_index]# 对应的是训练集中的训练y
    X_test_folds = X_train[test_index]#对应的是训练集中的测试的X
    y_test_folds = y_train_5[test_index]#对应的是训练集中的测试的Y
    ...
    print(n_correct / len(y_pred))#得到预测对的精度
